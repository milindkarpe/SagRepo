...
namespace SAG
{
    public partial class AddCust : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string Code = customerDAL.SaveCustomerDAL("code",txtIntroducer.Text, ddlPre.SelectedItem.Text.ToString(), txtName.Text, ddlSDW.SelectedItem.Text.ToString()
                , txtSDW.Text, txtPan.Text, txtEmail.Text, txtPreAdd.Text, txtPerAdd.Text, txtPrePin.Text, txtPerPin.Text, txtMobile.Text, txtNominee.Text, txtTelephone.Text
                , txtRelation.Text, Convert.ToDateTime(txtDOB.Text.ToString()), Convert.ToDateTime(txtDBONom.Text.ToString()), Convert.ToInt16(txtAge.Text), Convert.ToInt16(txtAgeNom.Text), System.DateTime.Now,
                branchId, ddlNomPre.SelectedItem.Text.ToString());
